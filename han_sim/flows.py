...
# v2.0.0 Phase 2.4: 派系簇（L22-225 共 180 行）已抽到 flows_faction.py
from han_sim.flows_faction import (
    FACTION_THRESHOLDS,
    FACTION_DECREE_MODIFIERS,
    FACTION_METRIC_SENSITIVITY,
    calc_faction_influence,
    apply_faction_events,
    get_faction_decree_modifier,
    calc_decree_faction_modifier,
    log_faction_influence_change,
)
