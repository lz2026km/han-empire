...
def calc_faction_influence(state: GameState, db: GameDB) -> Dict[str, float]:
    ...
    - 忠汉派：忠诚大臣数量×10 + 威权×0.4 + 声望×0.2 - 藩镇×0.3
    - 务实派：观望大臣数量×8 + 声望×0.3 + 藩镇×0.1
    - 离心派：离心/叛逆大臣数量×15 + 藩镇×0.4 - 威权×0.3 - 声望×0.2
    - 叛逆派：叛逆大臣数量×20 + 藩镇×0.5 - 威权×0.4 - 声望×0.2

    派系影响力受指标敏感性调节，形成动态联动。
    返回 {派系名: 影响力值}
    """
