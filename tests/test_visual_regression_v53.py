...
EXPECTED_FILES = [
    ("portraits/main/liuxie_emperor.jpg", (512, 1024), 50),
    ("banner_empire.jpg", (1024, 600), 200),
    ("bg_season_spring.jpg", (1024, 600), 200),
    ("bg_season_summer.jpg", (1024, 600), 200),
    ("bg_season_autumn.jpg", (1024, 600), 200),
    ("bg_season_winter.jpg", (1024, 600), 200),
    ("v4-epic/tab_hero_overview.jpg", (1024, 600), 200),
    ("v4-epic/tab_hero_decree.jpg", (1024, 600), 200),
    ("v4-epic/tab_hero_chat.jpg", (1024, 600), 200),
    ("v4-epic/tab_hero_ministers.jpg", (1024, 600), 200),
    ("v4-epic/tab_hero_factions.jpg", (1024, 600), 200),
    ("v4-epic/tab_hero_skills.jpg", (1024, 600), 200),
    ("v4-epic/tab_hero_buildings.jpg", (1024, 600), 200),
    ("v4-epic/tab_hero_map.jpg", (1024, 600), 200),
    ("v4-epic/tab_hero_orders.jpg", (1024, 600), 200),
    ("v4-epic/modal_report.jpg", (1024, 600), 200),
    ("v4-epic/modal_closed.jpg", (1024, 600), 200),
    ("v4-epic/modal_history.jpg", (1024, 600), 200),
    ("v4-epic/modal_extraction.jpg", (1024, 600), 200),
    ("v4-epic/modal_state.jpg", (1024, 600), 200),
    ("v4-epic/ending_zhongxing.jpg", (512, 1024), 200),
    ("v4-epic/ending_nanqian.jpg", (512, 1024), 200),
    ("v4-epic/ending_yihe.jpg", (512, 1024), 200),
    ("v4-epic/ending_chanrang.jpg", (512, 1024), 200),
    ("v4-epic/ending_yidaizhao.jpg", (512, 1024), 200),
    ("v4-epic/ending_liuwang.jpg", (512, 1024), 200),
    ("v4-epic/ending_bengpan.jpg", (512, 1024), 200),
]
